...
public class InnerClassPanel extends JPanel {
    ...
    private class CheckBoxListener implements ItemListener {
    	 ...
    	 @Override
         public void itemStateChanged(final ItemEvent e) { // ketchup, mustard, onions

             JCheckBox box = (JCheckBox) e.getSource();
             InnerClassPanel.this.checkBoxesSelected.add(box.getText());
             System.out.println(InnerClassPanel.this.checkBoxesSelected.toString());
    ...
    private class RadioButtonListener implements ActionListener {
        ...
        public void actionPerformed(final ActionEvent e) {
            ...
            JRadioButton context = (JRadioButton) e.getSource();
            InnerClassPanel.this.radioButtonSet = context.getText();
            System.out.println(context.getText()); // whatever value changes anyways
    ...
    private class SpinnerListener implements ChangeListener {
        ...
        public void stateChanged(final ChangeEvent e) {
            ...
            JSpinner context = (JSpinner) e.getSource();
            spinnerSet = (String) context.getValue();
    ...
    private class TextFieldListener implements ActionListener {
        ...
        public void actionPerformed(final ActionEvent e) {
            ...
            JTextField context = (JTextField) e.getSource();
            textEntry = context.getText();
