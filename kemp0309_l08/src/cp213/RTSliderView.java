...
// adjust to height... whoops
	...
	public void propertyChange(final PropertyChangeEvent evt) {
		// cast to int - JSlider doesn't accept doubles
	...
	RTSliderView.this.hypo.setText(RTSliderView.this.DECIMAL_FORMAT.format(RTSliderView.this.model.getHypotenuse()));
	}
    }
